...
[_BASE] = LAYOUT_preonic_grid(
  KC_ESC,        KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,             KC_7,    KC_8,          KC_9,    KC_0,       DK_GRV,
  KC_TAB,        KC_Q,    KC_W,    KC_F,    KC_P,    KC_B,    KC_J,             KC_L,    KC_U,          KC_Y,    DK_QUOT,    DK_QUES,
  ...
  KC_F24,        _______, KC_LGUI, KC_LALT, MO(1),   KC_SPC,  KC_SFTENT,        MO(2),   LCTL(KC_LSFT), SCRSHOT, KEYPIRANHA, KC_DEL
),
...
[_LOWER] = LAYOUT_preonic_grid(
  ...
  _______,      DK_DLR,  DK_DQUO,  DK_LCBR, DK_RCBR, DK_PIPE, DK_PERC, KC_7,      KC_8,    KC_9,    DK_CIRC, _______,
  ...
  _______,      _______, _______,  _______, _______, _______, KC_SPC,  LT(2,KC_0),KC_DOT,KC_COMMA, DK_TILD,  _______
),
...
[3] = LAYOUT_preonic_grid(
  KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,       DK_PLUS,
  ...
  KC_F24,  _______, KC_LALT, KC_SPC,  KC_SPC,  KC_SPC,  KC_BSPC, KC_SPC,  KC_DEL,  SCRSHOT, TO(0),      KC_DEL
),
